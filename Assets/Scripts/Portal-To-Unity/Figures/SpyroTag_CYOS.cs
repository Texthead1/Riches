...
#region FigType Info
        ...
        {
            Debug.LogWarning(SpyroTag->magicMoment.crcCYOS.ChangeLittleEndianValue(EndianHelper.NativeEndianness).ToString("X4"));
            Debug.LogError(CalculateCRCCYOS().ToString("X4"));
        }
