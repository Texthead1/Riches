...
#region FigType Info
        ...
        {
            Debug.LogWarning(SpyroTag->magicMoment.crcTrap.ChangeLittleEndianValue(EndianHelper.NativeEndianness).ToString("X4"));
            Debug.LogError(CalculateCRCTrap().ToString("X4"));
        }
